...
import CompletedContainer from '../../lessons/lesson_complete/completed_container'
 ...
 export const grandLessonsObj = {
    ...
    //  < ConstructSentence sentence = { "Hello, I am hiding eggs"} correct = { ["Bonjour je cache des oeufs"]} words = { ["Bonjour", "je", "cache", "des", "oeufs"]} />
        ...
        "jp": {
            "Hiragana-1": [<MarkMeaningContainer sentence={"私の名前は"} eng={false} correct={["My name is"]} phrase1={"My name is"} phrase2={"A girl's name is"} phrase3={"Your name is"} />, <TranslateSentenceContainer sentence={"に"} correct={["two"]} />, <MarkMeaningContainer sentence={"水"} eng={false} correct={["water"]} phrase1={"Milk"} phrase2={"Gatorade"} phrase3={"Water"} />, <TranslateSentenceContainer sentence={"こんにちは、さようなら"} correct={["hello, goodbye"]} />],
