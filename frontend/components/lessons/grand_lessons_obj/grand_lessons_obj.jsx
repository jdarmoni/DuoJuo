...
import CompletedContainer from '../../lessons/lesson_complete/completed_container'
 ...
 export const grandLessonsObj = {
    //  < TranslateSentenceContainer sentence = { "Le chien est effrayant"} correct = { ["the dog is scary"]} />
        ...
        "jp": {
            "Hiragana-1": [<MarkMeaningContainer sentence={"私の名前は"} correct={["My name is"]} phrase1={"My name is"} phrase2={"A girl's name is"} phrase3={"Your name is"} />, <TranslateSentenceContainer sentence={"たべる"} correct={["To eat"]} />, <MarkMeaningContainer sentence={"水"} correct={["water"]} phrase1={"Milk"} phrase2={"Gatorade"} phrase3={"Water"} />, <TranslateSentenceContainer sentence={"こんにちは、さようなら"} correct={["hello, goodbye"]} />],
