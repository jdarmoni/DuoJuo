...
import CompletedContainer from '../../lessons/lesson_complete/completed_container'
 ...
 export const grandLessonsObj = {
        ...
        "ge": {
            ...
            "Greetings": [<TranslateSentenceContainer sentence={"Hallo, ich bin der junge"} correct={["Hello, I am the boy"]} />, <TranslateSentenceContainer sentence={"Der film"} correct={["the film"]} />, <TranslateSentenceContainer sentence={"Ich heiße Christoph Waltz"} correct={["My name is Christoph Waltz"]} />, <TranslateSentenceContainer sentence={"Ich mag Duolingo"} correct={["I like Duolingo"]} />],
        ...
        "es": {
            ...
            "Greetings": [<TranslateSentenceContainer sentence={"Mi nombre es rafael nadal"} correct={["My name is Rafael Nadal"]} />, <TranslateSentenceContainer sentence={"Soy apasionado"} correct={["I am passionate"]} />, <TranslateSentenceContainer sentence={"Mi mejor amigo se llama Roger"} correct={["My best friend is named Roger"]} />, <TranslateSentenceContainer sentence={"I have won Roland Garros 12 times, no?"} correct={["He ganado Roland Garros 12 veces, ¿no?"]} />],
            "Basics-2": [<TranslateSentenceContainer sentence={"Yo soy de Mallorca"} correct={["I am from Mallorca"]} />, <TranslateSentenceContainer sentence={"Mis brazos son espectaculares"} correct={["My arms are spectacular"]} />, <TranslateSentenceContainer sentence={"Siempre pelearé por ti"} correct={["I will always fight for you"]} />, <TranslateSentenceContainer sentence={"My name is Rafael Nadal"} correct={["Mi nombre es rafael nadal"]} />]
        }
