 ...
 export const grandLessonsObj = {
    ...
    //  < ConstructSentence sentence = { "Hello, I am hiding eggs"} correct = { ["Bonjour je cache des oeufs"]} words = { ["Bonjour", "je", "cache", "des", "oeufs"]} />
        ...
        "fr": {
         ...
         "Basics-2": [<TranslateSentenceContainer sentence={"Petite cerises"} correct={["little cherries"]} />, < ConstructSentence sentence={"I am alone at Dunkin Donuts"} correct={["Je suis seule a Dunkin Donuts"]} words={["seule", "Je", "Donuts", "a", "Dunkin", "suis"]} />, < TranslateSentenceContainer sentence={"D'ou etes-vous?"} correct={["Where are you from?"]} />, < MarkMeaningContainer sentence={"Je suis un célébrité"} correct={["I am a celebrity"]} phrase1={"I am a celebrated person"} phrase2={"Everyone knows me"} phrase3={"I am a celebrity"} />,]
            //  
        },
        "jp": {
            "Hiragana-1": [<MarkMeaningContainer sentence={"私の名前は"} correct={["My name is"]} phrase1={"My name is"} phrase2={"A girl's name is"} phrase3={"Your name is"} />, <TranslateSentenceContainer sentence={"に"} correct={["two"]} />, <MarkMeaningContainer sentence={"水"} correct={["water"]} phrase1={"Milk"} phrase2={"Gatorade"} phrase3={"Water"} />, <TranslateSentenceContainer sentence={"こんにちは、さようなら"} correct={["hello, goodbye"]} />],
        ...
        "es": {
            "Intro": [<TranslateSentenceContainer sentence={"el cerdo esta durmiendo"} correct={["the pig is sleeping"]} />, <ConstructSentence sentence={"Soy el chico que bebe leche"} correct={["I am the boy who drinks milk"]} words={["drinks", "am", "I", "the", "boy", "milk", "who"]} />, <TranslateSentenceContainer sentence={"eres un pájaro?"} correct={["are you a bird?"]} />, <MarkMeaningContainer sentence={"dime porque sueño"} correct={["tell me why I dream"]} phrase1={"the pork costs a dime"} phrase2={"why do you dream of pork"} phrase3={"tell me why I dream"}/>],
            "Phrases": [<MarkMeaningContainer sentence={"Mi nombre es Rafael Nadal"} correct={["My name is Rafael Nadal"]} phrase1={"My name is Novak Djokovic"} phrase2={"My name is Roger Federer"} phrase3={"My name is Rafael Nadal"} />, <TranslateSentenceContainer sentence={"Soy apasionado"} correct={["I am passionate"]} />, <ConstructSentence sentence={"My best friend is named Roger"} correct={["Mi mejor amigo se llama Roger"]} words={["llama", "Roger", "mejor", "amigo", "Mi", "se"]} />, <MarkMeaningContainer sentence={"He ganado Roland Garros 12 veces, ¿no?"} correct={["I have won Roland Garros 12 times, no?"]} phrase1={"I have won Wimbledon 12 times, no?"} phrase2={"I have won Roland Garros 12 times, no?"} phrase3={"I have lost the Australian Open 4 times, no?"} />],
